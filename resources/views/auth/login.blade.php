      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="userccount">
          ...
          <div class="formpanel">
            ...
            <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required autofocus placeholder="{{__('Alamat Email')}}">
              @if ($errors->has('email'))
          ...
          <!-- sign up form -->
          <div class="newuser"><i class="fa fa-user" aria-hidden="true"></i> {{__('Pengguna Baru')}}? <a href="{{route('register')}}">{{__('Disini')}}</a></div>
          <div class="newuser"><i class="fa fa-user" aria-hidden="true"></i> {{__('Lupa Password')}}? <a href="{{ route('password.request') }}">{{__('Disini')}}</a></div>
          <!-- sign up form end--> 
