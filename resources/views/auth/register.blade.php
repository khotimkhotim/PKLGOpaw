...
<div class="listpgWraper">
  ...
  @include('flash::message')
    <div class="row">
      ...
      ?>
              <li class="{{($c_or_e == 'candidate')? 'active':''}}"><a data-toggle="tab" href="#candidate" aria-expanded="true">{{__('Siswa')}}</a></li>
              <li class="{{($c_or_e == 'employer')? 'active':''}}"><a data-toggle="tab" href="#employer" aria-expanded="false">{{__('Perusahaan')}}</a></li>
            </ul>
          </div>
            ...
            <div id="candidate" class="formpanel tab-pane fade {{($c_or_e == 'candidate')? 'active in':''}}">
              <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                ...
                <div class="formrow{{ $errors->has('first_name') ? ' has-error' : '' }}">
                  <input type="text" name="first_name" class="form-control" required="required" placeholder="{{__('Nama Depan')}}" value="{{old('first_name')}}">
                ...
                <div class="formrow{{ $errors->has('middle_name') ? ' has-error' : '' }}">
                  <input type="text" name="middle_name" class="form-control" placeholder="{{__('Nama Tengah')}}" value="{{old('middle_name')}}">
                ...
                <div class="formrow{{ $errors->has('last_name') ? ' has-error' : '' }}">
                  <input type="text" name="last_name" class="form-control" required="required" placeholder="{{__('Nama Belakang')}}" value="{{old('last_name')}}">
                ...
                <div class="formrow{{ $errors->has('terms_of_use') ? ' has-error' : '' }}">
                  ...
                  <a href="{{url('terms-of-use')}}">{{__('Saya menerima Ketentuan')}}</a>
            ...
            <div id="employer" class="formpanel tab-pane fade {{($c_or_e == 'employer')? 'active in':''}}">
              <form class="form-horizontal" method="POST" action="{{ route('company.register') }}">
                ...
                <div class="formrow{{ $errors->has('name') ? ' has-error' : '' }}">
                  <input type="text" name="name" class="form-control" required="required" placeholder="{{__('Nama Perusahaan')}}" value="{{old('name')}}">
                ...
                <div class="formrow{{ $errors->has('password') ? ' has-error' : '' }}">
                  ...
                  @if ($errors->has('password')) <span class="help-block"> <strong>{{ $errors->first('password') }}</strong> </span> @endif </div>
                <div class="formrow{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                  <input type="password" name="password_confirmation" class="form-control" required="required" placeholder="{{__('Konfirmasi Password')}}" value="">
                  @if ($errors->has('password_confirmation')) <span class="help-block"> <strong>{{ $errors->first('password_confirmation') }}</strong> </span> @endif </div>
                <div class="formrow{{ $errors->has('terms_of_use') ? ' has-error' : '' }}">
                  <input type="checkbox" value="1" name="terms_of_use" />
                  <a href="{{url('terms-of-use')}}">{{__('Saya menerima Ketentuan')}}</a>
          ...
          <!-- sign up form -->
          <div class="newuser"><i class="fa fa-user" aria-hidden="true"></i> {{__('Punya Akun')}}? <a href="{{route('login')}}">{{__('Sign in')}}</a></div>
          <!-- sign up form end--> 
