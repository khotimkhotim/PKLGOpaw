...
@include('includes.inner_page_title', ['page_title'=>__('Detail Perusahaan')]) 
      ...
      <div class="col-md-8"> 
        ...
        <div class="job-header">
          ...
          <div class="contentbox">
            ...
            <h3>{{__('About ')}}</h3><h3>{{$company->name}}</h3>
          ...
          <div class="jobdetail">
            ...
            <ul class="jbdetail">
              ...
              <li class="row">
                ...
                <div class="col-md-6 col-xs-6">{{__('Total Perusahaan')}}</div>
              ...
              <li class="row">
                ...
                <div class="col-md-6 col-xs-6">{{__('Berdiri Sejak')}}</div>
              ...
              <li class="row">
                ...
                <div class="col-md-6 col-xs-6">{{__('Info')}}</div>
