...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="formrow">
      ...
      <label class="btn btn-default"> {{__('Pilih Logo Perusahaan')}}
...
<div class="row">
  <div class="col-md-4">
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'name') !!}"> {!! Form::text('name', null, array('class'=>'form-control', 'id'=>'name', 'placeholder'=>__('Nama Perusahaan'))) !!}
  ...
  <div class="col-md-4">
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'ceo') !!}"> {!! Form::text('ceo', null, array('class'=>'form-control', 'id'=>'ceo', 'placeholder'=>__('CEO Perusahaan'))) !!}
      {!! APFrmErrHelp::showErrors($errors, 'ceo') !!} </div>
  </div>
  <div class="col-md-4">
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'industry_id') !!}"> {!! Form::select('industry_id', ['' => __('Industry')]+$industries, null, array('class'=>'form-control', 'id'=>'industry_id')) !!}
  ...
  <div class="col-md-12">
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'description') !!}"> {!! Form::textarea('description', null, array('class'=>'form-control', 'id'=>'description', 'placeholder'=>__('Detail Perusahaan'))) !!}
  ...
  <div class="col-md-12">
    <div class="formrow">
      <button type="submit" class="btn">{{__('Update dan Simpan')}} <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
    </div>
  </div>
</div>
{!! Form::close() !!}
