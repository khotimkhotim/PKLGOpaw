...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'name') !!}"> {!! Form::label('name', 'Nama Perusahaan', ['class' => 'bold']) !!}
        {!! Form::text('name', null, array('class'=>'form-control', 'id'=>'name', 'placeholder'=>'Company Name')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'name') !!} </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'email') !!}"> {!! Form::label('email', 'Email Perusahaan', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'ceo') !!}"> {!! Form::label('ceo', 'CEO Perusahaan', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'description') !!}"> {!! Form::label('description', 'Detail Perusahaan', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'location') !!}"> {!! Form::label('location', 'Alamat', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'no_of_offices') !!}"> {!! Form::label('no_of_offices', 'Jumlah Perusahaan', ['class' => 'bold']) !!}
        {!! Form::select('no_of_offices', ['' => 'Banyak Perusahaan']+MiscHelper::getNumOffices(), null, array('class'=>'form-control', 'id'=>'no_of_offices')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'no_of_employees') !!}"> {!! Form::label('no_of_employees', 'Jumlah Karyawan', ['class' => 'bold']) !!}
        {!! Form::select('no_of_employees', ['' => 'Banyaknya Karyawan']+MiscHelper::getNumEmployees(), null, array('class'=>'form-control', 'id'=>'no_of_employees')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'no_of_employees') !!} </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'established_in') !!}"> {!! Form::label('established_in', 'Berdiri Sejak', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'country_id') !!}"> {!! Form::label('country_id', 'Negara', ['class' => 'bold']) !!}                    
        {!! Form::select('country_id', ['' => 'Pilih Negara']+$countries, old('country_id', (isset($company))? $company->country_id:$siteSetting->default_country_id), array('class'=>'form-control', 'id'=>'country_id')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'country_id') !!} </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'state_id') !!}"> {!! Form::label('state_id', 'Provinsi', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'city_id') !!}"> {!! Form::label('city_id', 'Kota', ['class' => 'bold']) !!}  
        ...
        <div class="form-group {!! APFrmErrHelp::hasError($errors, 'company_package_id') !!}"> {!! Form::label('company_package_id', 'Paket', ['class' => 'bold']) !!}  
        {!! Form::select('company_package_id', ['' => 'Pilih Paket']+$packages, null, array('class'=>'form-control', 'id'=>'company_package_id')) !!}
