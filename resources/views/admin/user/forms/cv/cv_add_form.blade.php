...
<div class="modal-body">
        <div class="form-body">
          <div class="form-group" id="div_name">
            <label for="name" class="bold">Judul Proposal</label>
          ...
          <div class="form-group" id="div_cv_file">
            <label for="cv_file" class="bold">File</label>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-large btn-primary">Tambah Proposal <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
      </div>
      </form>
