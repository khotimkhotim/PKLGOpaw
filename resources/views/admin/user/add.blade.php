    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="{{ route('list.users') }}">User</a> <i class="fa fa-circle"></i> </li>
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo"> <i class="icon-settings font-red-sunglo"></i> <span class="caption-subject bold uppercase">Form User</span> </div>
                    </div>
                    ...
                    <div class="portlet-body form">          
                        <ul class="nav nav-tabs">              
                            ...
                            <li><a href="#CV" data-toggle="tab" aria-expanded="false">Proposal</a></li>
                            <li><a href="#Education" data-toggle="tab" aria-expanded="false">Pendidikan</a></li>
                            <li><a href="#Skills" data-toggle="tab" aria-expanded="false">Skills</a></li>
                            <li><a href="#Languages" data-toggle="tab" aria-expanded="false">Bahasa</a></li>
