...
@include('includes.inner_page_title', ['page_title'=>__('Detail')]) 
          ...
          <div class="jobdetail">
            ...
            <ul class="jbdetail">
              ...
              <li class="row">
                ...
                <div class="col-md-4 col-xs-5">{{__('Perusahaan')}}</div>
              ...
              <li class="row">
                ...
                <div class="col-md-4 col-xs-5">{{__('Jenis Kelamin')}}</div>
              ...
              <li class="row">
                ...
                <div class="col-md-4 col-xs-5">{{__('Sebelum')}}</div>
