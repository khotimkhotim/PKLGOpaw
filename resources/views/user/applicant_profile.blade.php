...
<div class="listpgWraper">
  ...
  @include('flash::message')  
    ...
    <div class="job-header">
        ...
        <div class="row">
          <div class="col-md-8 col-sm-8"> 
            ...
            <div class="candidateinfo">
              ...
              <div class="loctext"><i class="fa fa-history" aria-hidden="true"></i> {{__('Member Sejak')}}, {{$user->created_at->format('M d, Y')}}</div>
      ...
      <a href="#contact_applicant" class="btn"><i class="fa fa-envelope" aria-hidden="true"></i> {{__('Pesan')}}</a>
        ...
        <div class="job-header">
          <div class="jobdetail">
            ...
            <ul class="jbdetail">
              ...
              <li class="row">
                <div class="col-md-6 col-xs-6">{{__('Email Terferifikasi')}}</div>
                <div class="col-md-6 col-xs-6"><span>{{((bool)$user->verified)? 'Ya':'Tidak'}}</span></div>
              </li>
              <li class="row">
                <div class="col-md-6 col-xs-6">{{__('Umur')}}</div>
                <div class="col-md-6 col-xs-6"><span>{{$user->getAge()}} Tahun</span></div>
              </li>
              <li class="row">
                <div class="col-md-6 col-xs-6">{{__('Jenis Kelamin')}}</div>
        ...
        <div class="job-header">
          <div class="jobdetail">
            ...
            <form method="post" id="send-applicant-message-form">
              ...
              <div class="formpanel">
                <div class="formrow">
                  <input type="text" name="from_name" value="{{ $from_name }}" class="form-control" placeholder="{{__('Nama')}}">
                </div>
                <div class="formrow">
                  <input type="text" name="from_email" value="{{ $from_email }}" class="form-control" placeholder="{{__(' Email')}}">
                </div>
                <div class="formrow">
                  <input type="text" name="from_phone" value="{{ $from_phone }}" class="form-control" placeholder="{{__('Telpon')}}">
                </div>
                <div class="formrow">
                  <input type="text" name="subject" value="{{ $subject }}" class="form-control" placeholder="{{__('Subject')}}">
                </div>
                <div class="formrow">
                  <textarea name="message" class="form-control" placeholder="Pesan">{{ $message }}</textarea>
                </div>                
                <div class="formrow">
                <input type="button" class="btn" value="{{__('Kirim')}}" id="send_applicant_message">
                </div>
              </div>
            </form>
